...
const QUEST_POOL: QuestTemplate[] = [
  ...
  },
  {
    ...
    description: "Consulte la carte monde et explore les villes.",
    actionId: "open-world-map",
    xpReward: 15,
    moneyReward: 5,
  },
  {
    category: "explore",
    emoji: "🏙️",
    title: "Explorer Neo Paris",
    description: "Visite la carte Neo Paris et observe les NPCs.",
    actionId: "open-city-map",
    xpReward: 18,
    moneyReward: 5,
  },
  {
    ...
    description: "Participe à l'événement mondial du jour.",
    actionId: "join-world-event",
    xpReward: 50,
    moneyReward: 20,
  },
  // ── Progression ───────────────────────────────────────────────────────────────
