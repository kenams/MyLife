...
export function subscribeLocalCityPlayers(listener: (player: MapPlayer) => void) {
  ...
  // Rejoue l'état courant : un abonné tardif (écran Map monté APRÈS le premier
  // publish de CityRuntime) ne recevait sinon que les diffs suivants et ne
  // voyait qu'une fraction de la ville.
