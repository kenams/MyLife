...
export const MOCK_PLAYERS: MapPlayer[] = [
  ...
  },
  {
    ...
    status: "free", lat: 48.8640, lng: 2.4425, location_name: "Montreuil",
    location_verified: true, last_action: "Roupiller", is_star: false, is_npc: true,
    level: 3, crew_color: null, crew_tag: null, updated_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    level: 5, crew_color: null, crew_tag: null,
