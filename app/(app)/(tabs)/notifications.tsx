...
import {
  ...
  type SeasonMission, type District, type MissionParticipationStatus, type MoveSession,
} from "@/lib/season";
...
function MoveMissionModal({ mission, onClose, onClaimed }: {
  ...
  return (
    <Modal transparent animationType="slide" visible onRequestClose={onClose}>
      ...
      <View style={{ backgroundColor: L.card, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, gap: 14 }}>
        ...
        {state === "ready" && (
          <>
            <Text style={{ color: L.gold, fontSize: 12 }}>Objectif : {target} m à parcourir</Text>
            <Text style={{ color: L.gold, fontSize: 12 }}>
