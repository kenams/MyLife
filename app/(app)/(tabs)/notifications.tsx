  ...
  return (
    <Animated.View style={{ flex: 1, opacity: fadeAnim, backgroundColor: L.bg }}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        {/* ── SAISON 1 — Toulouse s'éveille (hub complet sur son écran) ── */}
        <Pressable
          onPress={() => router.push("/(app)/season")}
          style={{
            marginHorizontal: 16, marginBottom: 8,
            backgroundColor: "rgba(255,214,0,0.06)",
            borderRadius: 14, borderWidth: 1, borderColor: "rgba(255,214,0,0.25)",
            padding: 14, flexDirection: "row", alignItems: "center", gap: 12,
          }}
        >
          <Text style={{ fontSize: 22 }}>🌆</Text>
          <View style={{ flex: 1 }}>
            <Text style={{ color: L.primary, fontSize: 13, fontWeight: "900" }}>Toulouse s'éveille</Text>
            <Text style={{ color: L.muted, fontSize: 11.5, marginTop: 2 }}>
              Missions IRL, quartiers, classements, défis du jour — ouvre le hub de saison.
            </Text>
          </View>
          <Ionicons name="chevron-forward" size={18} color={L.textSoft} />
        </Pressable>
